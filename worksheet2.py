...
Original file is located at
    https://colab.research.google.com/drive/1JPoUrRye5NP26Jzbbqg2tLVtJJo7MpbD
"""

#3.1
#Q.1
import pandas as pd
reader = pd.read_csv("/content/drive/MyDrive/Krishika/bank .csv")
...
#Q.4
import pandas as pd
reader = pd.read_csv("/content/banknumericdata.csv")
data_frame = pd.DataFrame(reader)
...
#Q.1
import pandas as pd
reader= pd.read_csv("/content/drive/MyDrive/Krishika/medical_students_dataset.csv")
data_frame = pd.DataFrame(reader)
print(data_frame)
...
#Problem1
import pandas as pd
reader = pd.read_csv("/content/drive/MyDrive/Krishika/Titanic-Dataset.csv")
data_frame = pd.DataFrame(reader)
